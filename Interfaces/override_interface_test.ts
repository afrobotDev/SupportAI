...
import type {
  ...
  ErrorEvent,
  OutageEvent,
} from "./override_interface.ts";
import { getHighPriorityEvents } from "./override_interface.ts";

type Expect<T extends true> = T;
type Extends<T, U> = T extends U ? true : false;

await describe("SystemEvent extensions", async () => {
...
await describe("getHighPriorityEvents", async () => {
  const runCases: [
