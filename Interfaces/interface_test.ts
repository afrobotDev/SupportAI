...
import { getSessionDuration } from "./interface.ts";
import type { SupportSession, UserFeedback } from "./interface.ts";

type Expect<T extends true> = T;
type Extends<T, U> = T extends U ? true : false;

await describe("UserFeedback and SupportSession interfaces", async () => {
...
await describe("getSessionDuration", async () => {
